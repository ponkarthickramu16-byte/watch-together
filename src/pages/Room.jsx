...
function Room() {
    ...
    useEffect(() => {
        ...
        if (!authChecked) return;
        if (isPlaying && roomDocId && roomData?.movieUrl && username && !historyLoggedRef.current && roomData?.movieType !== "drive" && !getDriveFileId(roomData?.movieUrl || "")) {
                            ...
                            >
                                {isYouTubeVideo && youtubeId ? (
                                    ...
                                    <video
                                        ...
                                        onSeeked={handleSeek}
                                        onError={() => showToast("❌ Drive video load ஆகல. File-ஐ 'Anyone with the link' share பண்ணி try பண்ணு", "⚠️", "#e74c3c")}
                                    />
                                ) : hasMovieUrl ? (
                                    <video
                                        ref={videoRef}
