...
export default function ProfileSetup({ user, onComplete, existingProfile = null }) {
    ...
    const [tab, setTab] = useState(existingProfile?.photoUrl || googlePhoto ? "upload" : "avatar");
            ...
            <div style={{ width: "100%", maxWidth: "480px", backgroundColor: "#1a1a1a", borderRadius: "20px", border: "1px solid #333", overflow: "hidden" }}>
                ...
                <div style={{ padding: "24px", display: "flex", flexDirection: "column", gap: "20px" }}>
                                ...
                                {tab === "upload" && (
                                    <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
                                        {photoUrl && photoUrl === googlePhoto && !existingProfile?.photoUrl && (
                                            <p style={{ color: "#27ae60", fontSize: "11px", margin: 0 }}>✅ Google photo automatic-ஆ set ஆச்சு</p>
                                        )}
                    ...
                    <div>
                        ...
                        <input value={email} readOnly placeholder="Email load ஆகல — refresh பண்ணு"
                        ...
                        {!email && <p style={{ color: "#f39c12", fontSize: "11px", margin: "4px 0 0" }}>⚠️ Email தெரியல — logout பண்ணி மறுபடியும் login பண்ணு</p>}
                    </div>
